...
import org.garen.mc.swagger.model.User;
...
public interface UserApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful mc", response = Void.class) })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful mc", response = User.class),
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful mc", response = String.class),
