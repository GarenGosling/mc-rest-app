...
public interface MenuApi {
    ...
    ResponseEntity<ResponseModel> deleteMenu(@ApiParam(value = "菜单ID") @RequestParam(value = "id", required = false) Integer id);
    ...
    @RequestMapping(value = "/menu",
        method = RequestMethod.GET)
    ResponseEntity<ResponseModel> getMenu(@ApiParam(value = "菜单ID") @RequestParam(value = "id", required = false) Integer id);
