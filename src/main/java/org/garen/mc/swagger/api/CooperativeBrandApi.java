...
@Api(value = "cooperativeBrand", description = "the cooperativeBrand API")
public interface CooperativeBrandApi {

    @ApiOperation(value = "获取合作品牌列表", notes = "获取合作品牌列表 ", response = SuccessModel.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = SuccessModel.class),
        @ApiResponse(code = 200, message = "unexpected error", response = ErrorModel.class) })
    
    @RequestMapping(value = "/cooperativeBrand/all",
        method = RequestMethod.GET)
    ResponseEntity<SuccessModel> getCoperativeBrand();
